...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x0fAddRoleResponse\x12\x14\n" +
	"\x05roles\x18\x01 \x03(\tR\x05roles2\xe8\x01\n" +
	"\x04Auth\x129\n" +
...
var file_sso_sso_proto_goTypes = []any{
	...
	(*AddRoleRequest)(nil),   // 6: auth.AddRoleRequest
	(*AddRoleResponse)(nil),  // 7: auth.AddRoleResponse
}
var file_sso_sso_proto_depIdxs = []int32{
	...
	6, // 3: auth.Auth.AddRole:input_type -> auth.AddRoleRequest
	2, // 4: auth.Auth.Register:output_type -> auth.RegisterResponse
	3, // 5: auth.Auth.Login:output_type -> auth.LoginResponse
	5, // 6: auth.Auth.RefreshToken:output_type -> auth.RefreshResponse
	7, // 7: auth.Auth.AddRole:output_type -> auth.AddRoleResponse
